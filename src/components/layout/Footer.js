        ...
        <div className={styles.footerGrid}>
          <div>
            ...
            <div className={styles.footerSocial}>
              <a href="https://www.facebook.com/profile.php?id=61573726200279" aria-label="Facebook">
              ...
              <a href="https://www.tiktok.com/@invoicepay.fi?lang=en" aria-label="TikTok">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="16" height="16" fill="currentColor">
                  <path d="M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,121.43,0,0,0,67,20.14Z"/>
                </svg>
              </a>
              <a href="https://www.linkedin.com/company/invoicepay/" aria-label="LinkedIn">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="16" height="16" fill="currentColor">
                  <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/invoicepay.fi/" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="16" height="16" fill="currentColor">
          ...
          <div>
            <h3 className={styles.footerHeading}>{translations.Footer?.sections.services.title}</h3>
            <ul className={styles.footerLinks}>
              <li>
                <Link href={`/${currentLang}/for-freelancers`}>
                  {translations.Footer?.sections.services.links.forFreelancers}
                </Link>
              </li>
              <li>
                <Link href={`/${currentLang}/for-startups`}>
                  {translations.Footer?.sections.services.links.forStartups}
                </Link>
              </li>
              <li>
                <Link href={`/${currentLang}/for-construction`}>
                  {translations.Footer?.sections.services.links.forConstruction}
                </Link>
              </li> 
              <li>
                <Link href={`/${currentLang}/for-restaurants`}>
                  {translations.Footer?.sections.services.links.forRestaurants}
                </Link>
              </li> 
              <li>
                <Link href={`/${currentLang}/for-stores`}>
                  {translations.Footer?.sections.services.links.forStores}
                </Link>
              </li> 
            </ul>
          </div>
